  ...
  /*! License details at fancyapps.com/license */ (function (e, t) {
      ...
      let D = {
        ...
        start: function (t) {
          return (
            (e = w.Initializing),
            y((p = { ...v }), x) ||
              (I.add(this), $ || ($ = window.requestAnimationFrame(E)), A(t)),
            D
          );
        },
        pause: function () {
    ...
    let j = (e) => {
      ...
      G = (e, t) => {
        ...
        function k(e) {
          let t = e.target;
          (W = !1),
            t && !e.defaultPrevented && (Z || (j(e), e.stopPropagation()));
        }
        let I = {
          init: function () {
            if (e)
        ...
        function P(n) {
          ...
          if (l) {
            switch (l) {
              ...
              case J.ZoomIn:
              case J.ZoomOut:
                Z(l, { scale: parseFloat(s || "") || void 0 });
                break;
              case J.MoveLeft:
              case J.MoveRight:
                Z(l, { deltaX: parseFloat(s || "") || void 0 });
                break;
              case J.MoveUp:
              case J.MoveDown:
                Z(l, { deltaY: parseFloat(s || "") || void 0 });
                break;
              default:
                Z(l);
            }
    ...
    let er = (e, t) => {
      ...
      eh = (e, t = {}, o = {}) => {
                    ...
                    (i = G(M, e)
                      ...
                      .on("end", (e) => {
                        ...
                        if (
                          ...
                          return void eL(A, { transition: "tween" });
                        let d = Q(s);
                        Math.abs(r) > 10 &&
                          d === A &&
                          (r > 0
        ...
        function X() {
          ...
          e !== A && ((g = A), (A = e), eM(), K(), J(), W("change", A, g));
        }
        function K() {
          if (!x) return;
        ...
        function el(e) {
          let t = e?.el;
          t && (t.remove(), ev(t), W("detachSlideEl", e));
        }
        function eu() {
        ...
        function eg() {
          ...
          if (
            ...
            (g = void 0), (A = j("initialPage"));
            let e = j("initialSlide") || void 0;
            void 0 !== e && (A = eP.getPageIndex(e) || 0),
              (A = m(0, A, H.length - 1)),
              (O = R = H[A]?.pos || 0);
          } else {
            let e = c?.isRunning() ? c.getEndValues().pos : R;
            (e < z || e > k) && (A = m(0, A, H.length - 1));
          }
          W("refresh");
        }
        function ev(e) {
        ...
        let eP = {
          add: function (e, t) {
            for (let n of eo(e, t)) W("addSlide", n);
            return U(I), eg(), eS(), eP;
          },
          canGoPrev: function () {
            return L || A > 0;
          ...
          emit: W,
          filter: function (e = "*") {
            return U(e), eg(), eS(), W("filter", e), eP;
          },
          getContainer: function () {
            return x;
          },
          ...
          init: function () {
            ...
            return (
              ...
              (b = t),
              window.removeEventListener("resize", Z),
              b.breakpoints && window.addEventListener("resize", Z),
              Z(),
              eP
            );
          },
        ...
        function c(t, o) {
          "html5video" === o.type &&
            (function (t) {
              ...
              if ((d.classList.add("f-html"), d.append(u), t.width)) {
                let e = `${t.width}`;
              ...
              if (t.aspectRatio) {
                ...
                (d.style.aspectRatio = `${t.aspectRatio}`),
                  (d.style[e.width > e.height ? "width" : "height"] = "auto");
              }
              (t.contentEl = u),
                (t.htmlEl = d),
    ...
    <div class="fancybox__container" tabindex="0" aria-label="{{MODAL}}">
      ...
      e8 = () => {
        ...
        function X() {
          W(), i?.classList.remove("is-idle"), (E = !1);
        }
        function K(n, o) {
      ...
      e9 = {
        ...
        fromEvent: function (e) {
          ...
          for (let [e, a] of e9.openers.entries())
            if (e.contains(i)) {
              for (let [l, r] of a.entries()) {
                let a = null;
                try {
                  a = i.closest(l);
                } catch (e) {}
